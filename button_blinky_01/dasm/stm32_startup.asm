...
00000000 <.debug_info>:
  ...
  90:	00000183 	andeq	r0, r0, r3, lsl #3
 ...
 148:	01950a00 	orrseq	r0, r5, r0, lsl #20
...
00000000 <.debug_str>:
  ...
  64:	75625c6d 	strbvc	r5, [r2, #-3181]!	; 0xfffff393
  68:	6e6f7474 	mcrvs	4, 3, r7, cr15, cr4, {3}
  6c:	696c625f 	stmdbvs	ip!, {r0, r1, r2, r3, r4, r6, r9, sp, lr}^
  70:	5f796b6e 	svcpl	0x00796b6e
  74:	75003130 	strvc	r3, [r0, #-304]	; 0xfffffed0
  78:	6769736e 	strbvs	r7, [r9, -lr, ror #6]!
  7c:	2064656e 	rsbcs	r6, r4, lr, ror #10
  80:	72616863 	rsbvc	r6, r1, #6488064	; 0x630000
  84:	64655f00 	strbtvs	r5, [r5], #-3840	; 0xfffff100
  88:	00617461 	rsbeq	r7, r1, r1, ror #8
  ...
  b0:	63657600 	cmnvs	r5, #0, 12
  b4:	73726f74 	cmnvc	r2, #116, 30	; 0x1d0
  b8:	755f5f00 	ldrbvc	r5, [pc, #-3840]	; fffff1c0 <Reset_Handler+0xfffff1c0>
  ...
  d0:	62735f00 	rsbsvs	r5, r3, #0, 30
  d4:	6c007373 	stcvs	3, cr7, [r0], {115}	; 0x73
  ...
  ec:	69750074 	ldmdbvs	r5!, {r2, r4, r5, r6}^
  f0:	5f38746e 	svcpl	0x0038746e
  f4:	53700074 	cmnpl	r0, #116	; 0x74
  f8:	6c004352 	stcvs	3, cr4, [r0], {82}	; 0x52
  fc:	20676e6f 	rsbcs	r6, r7, pc, ror #28
 100:	676e6f6c 	strbvs	r6, [lr, -ip, ror #30]!
 104:	746e6920 	strbtvc	r6, [lr], #-2336	; 0xfffff6e0
 108:	73447000 	movtvc	r7, #16384	; 0x4000
 10c:	6c5f0074 	mrrcvs	0, 7, r0, pc, cr4	; <UNPREDICTABLE>
 110:	61645f61 	cmnvs	r4, r1, ror #30
 114:	47006174 	smlsdxmi	r0, r4, r1, r6
 118:	4320554e 			; <UNDEFINED> instruction: 0x4320554e
 11c:	31203731 			; <UNDEFINED> instruction: 0x31203731
 120:	2e332e30 	mrccs	14, 1, r2, cr3, cr0, {1}
 124:	30322031 	eorscc	r2, r2, r1, lsr r0
 128:	38303132 	ldmdacc	r0!, {r1, r4, r5, r8, ip, sp}
 12c:	28203432 	stmdacs	r0!, {r1, r4, r5, sl, ip, sp}
 ...
 13c:	633d7570 	teqvs	sp, #112, 10	; 0x1c000000
 140:	6574726f 	ldrbvs	r7, [r4, #-623]!	; 0xfffffd91
 144:	346d2d78 	strbtcc	r2, [sp], #-3448	; 0xfffff288
 148:	746d2d20 	strbtvc	r2, [sp], #-3360	; 0xfffff2e0
 14c:	626d7568 	rsbvs	r7, sp, #104, 10	; 0x1a000000
 ...
 16c:	2d653776 	stclcs	7, cr3, [r5, #-472]!	; 0xfffffe28
 ...
 180:	7500746e 	strvc	r7, [r0, #-1134]	; 0xfffffb92
 184:	33746e69 	cmncc	r4, #1680	; 0x690
 188:	00745f32 	rsbseq	r5, r4, r2, lsr pc
 18c:	676e6f6c 	strbvs	r6, [lr, -ip, ror #30]!
 190:	746e6920 	strbtvc	r6, [lr], #-2336	; 0xfffff6e0
 194:	746e4300 	strbtvc	r4, [lr], #-768	; 0xfffffd00
 198:	69730072 	ldmdbvs	r3!, {r1, r4, r5, r6}^
