...
00000000 <.debug_info>:
  ...
  7c:	96070402 	strls	r0, [r7], -r2, lsl #8
  ...
  a8:	00000057 	andeq	r0, r0, r7, asr r0
  ...
  c0:	000000a3 	andeq	r0, r0, r3, lsr #1
  ...
  f8:	003b0900 	eorseq	r0, fp, r0, lsl #18
 ...
 12c:	00c80a74 	sbceq	r0, r8, r4, ror sl
...
00000000 <.debug_str>:
  ...
  10:	73447000 	movtvc	r7, #16384	; 0x4000
  14:	655f0074 	ldrbvs	r0, [pc, #-116]	; ffffffa8 <Reset_Handler+0xffffffa8>
  18:	00737362 	rsbseq	r7, r3, r2, ror #6
  1c:	657a6973 	ldrbvs	r6, [sl, #-2419]!	; 0xfffff68d
  20:	7479625f 	ldrbtvc	r6, [r9], #-607	; 0xfffffda1
  24:	73007365 	movwvc	r7, #869	; 0x365
  28:	732f6372 			; <UNDEFINED> instruction: 0x732f6372
  2c:	32336d74 	eorscc	r6, r3, #116, 26	; 0x1d00
  30:	6174735f 	cmnvs	r4, pc, asr r3
  34:	70757472 	rsbsvc	r7, r5, r2, ror r4
  38:	5200632e 	andpl	r6, r0, #-1207959552	; 0xb8000000
  3c:	74657365 	strbtvc	r7, [r5], #-869	; 0xfffffc9b
  ...
  54:	5f007261 	svcpl	0x00007261
  58:	74616465 	strbtvc	r6, [r1], #-1125	; 0xfffffb9b
  5c:	6f6c0061 	svcvs	0x006c0061
  ...
  8c:	6e69755f 	mcrvs	5, 3, r7, cr9, cr15, {2}
  90:	5f323374 	svcpl	0x00323374
  94:	6e750074 	mrcvs	0, 3, r0, cr5, cr4, {3}
  98:	6e676973 			; <UNDEFINED> instruction: 0x6e676973
  9c:	69206465 	stmdbvs	r0!, {r0, r2, r5, r6, sl, sp, lr}
  a0:	5f00746e 	svcpl	0x0000746e
  a4:	73736273 	cmnvc	r3, #805306375	; 0x30000007
  ...
  c0:	746e6975 	strbtvc	r6, [lr], #-2421	; 0xfffff68b
  c4:	00745f38 	rsbseq	r5, r4, r8, lsr pc
  c8:	43525370 	cmpmi	r2, #112, 6	; 0xc0000001
  cc:	6e6f6c00 	cdpvs	12, 6, cr6, cr15, cr0, {0}
  d0:	6f6c2067 	svcvs	0x006c2067
  d4:	6920676e 	stmdbvs	r0!, {r1, r2, r3, r5, r6, r8, r9, sl, sp, lr}
  d8:	4500746e 	strmi	r7, [r0, #-1134]	; 0xfffffb92
  dc:	736f5c3a 	cmnvc	pc, #14848	; 0x3a00
  e0:	74735c73 	ldrbtvc	r5, [r3], #-3187	; 0xfffff38d
  e4:	2d32336d 	ldccs	3, cr3, [r2, #-436]!	; 0xfffffe4c
  e8:	74747562 	ldrbtvc	r7, [r4], #-1378	; 0xfffffa9e
  ec:	622d6e6f 	eorvs	r6, sp, #1776	; 0x6f0
  f0:	6b6e696c 	blvs	1b9a6a8 <Reset_Handler+0x1b9a6a8>
  f4:	6f6e2d79 	svcvs	0x006e2d79
  f8:	6d61722d 	sfmvs	f7, 2, [r1, #-180]!	; 0xffffff4c
  fc:	6c65645c 	cfstrdvs	mvd6, [r5], #-368	; 0xfffffe90
 100:	625f7961 	subsvs	r7, pc, #1589248	; 0x184000
 104:	6b6e696c 	blvs	1b9a6bc <Reset_Handler+0x1b9a6bc>
 108:	37305f79 			; <UNDEFINED> instruction: 0x37305f79
