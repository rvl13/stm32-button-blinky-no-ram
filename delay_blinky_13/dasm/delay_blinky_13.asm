...
obj/delay_blinky_13.elf:     file format elf32-littlearm
...
08000008 <Reset_Handler>:
 ...
 8000018:	d3fc      	bcc.n	8000014 <Reset_Handler+0xc>
 ...
 8000024:	001e8e49 	andseq	r8, lr, r9, asr #28
...
00000000 <.debug_line>:
  ...
  e4:	230c0525 	movwcs	r0, #50469	; 0xc525
  e8:	05311505 	ldreq	r1, [r1, #-1285]!	; 0xfffffafb
  ec:	1f052321 	svcne	0x00052321
  f0:	201d0520 	andscs	r0, sp, r0, lsr #10
  f4:	77031005 	strvc	r1, [r3, -r5]
  f8:	00090220 	andeq	r0, r9, r0, lsr #4
...
00000000 <.debug_str>:
  ...
  48:	75003331 	strvc	r3, [r0, #-817]	; 0xfffffccf
