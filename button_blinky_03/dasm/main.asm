...
00000000 <Reset_Handler>:
  ...
  30:	40023830 	andmi	r3, r2, r0, lsr r8
  34:	40020c00 	andmi	r0, r2, r0, lsl #24
  38:	40020010 	andmi	r0, r2, r0, lsl r0
  3c:	40020c14 	andmi	r0, r2, r4, lsl ip

Disassembly of section .isr_vector:

00000000 <vectors>:
   0:	00020000 	andeq	r0, r2, r0
...
00000000 <.debug_line>:
  ...
  c8:	00000002 	andeq	r0, r0, r2
			c9: R_ARM_ABS32	.text
  cc:	01160300 	tsteq	r6, r0, lsl #6
  d0:	0a031005 	beq	c40ec <Reset_Handler+0xc40ec>
  ...
  e8:	1b030104 	blne	c0500 <Reset_Handler+0xc0500>
  ec:	00250520 	eoreq	r0, r5, r0, lsr #10
  f0:	20010402 	andcs	r0, r1, r2, lsl #8
  f4:	02001a05 	andeq	r1, r0, #20480	; 0x5000
  f8:	052f0104 	streq	r0, [pc, #-260]!	; fffffffc <Reset_Handler+0xfffffffc>
 ...
 10c:	0a022001 	beq	88118 <Reset_Handler+0x88118>
